        ...
        <div className="text-white text-center p-5 rounded-md">
          ...
          <div className="relative mt-6 w-full max-w-2xl mx-auto text-gray-700 dark:text-gray-300">
            <input
              ...
              type="search"
              className="w-full py-3 px-5 text-lg bg-white dark:bg-gray-300 border border-gray-300 dark:border-gray-700 rounded-full  dark:text-black focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-300 shadow-md"
              ...
              filteredRecipes.map((recipe) => (
                ...
                >
                  <button
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && handleMoreInfo(recipe)
                    }
                    tabIndex={0} // Permet de naviguer avec la touche tabulation
                  >
                    {recipe.title}
                  </button>
                </li>
